...
export default function DriversPage() {
  ...
  const getExpiredOrSuspendedDrivers = () => {
  ...
  const displayedDrivers = showExpiredSuspended
  ...
  const handleDeleteDriver = async () => {
    ...
    try {
      ...
      setDrivers((prev) =>
        prev.filter(
          (driver) => driver.license_number !== selectedDriver.license_number,
        ),
      );
  ...
  const handlePatchDriver = async (e) => {
    ...
    try {
      ...
      setDrivers((prev) =>
        prev.map((driver) =>
          driver.license_number === selectedDriver.license_number
            ? updatedDriver
            : driver,
        ),
      );
  ...
  return (
    <>
      ...
      <div style={{ padding: "20px", fontFamily: "sans-serif" }}>
        <div className="headerRow">
          ...
          <div className="searchRow">
            ...
            <button className="deleteBtn" onClick={handleDeleteDriver}>
              {" "}
              Delete Driver
            </button>
            <button className="updateBtn" onClick={handleUpdateDriver}>
              Update Driver
            </button>
          </div>
        </div>
                ...
                <tbody>
                  {displayedDrivers.map((driver) => (
                    <tr
                      ...
                      className={
                        selectedDriver?.license_number === driver.license_number
                          ? "selectedRow"
                          : ""
                      }
                    >
                      ...
                      <td>
                        {
                          new Date(driver.expiration_date)
                            .toISOString()
                            .split("T")[0]
                        }
                      </td>
      ...
      <AddDriverModal
        ...
        handleCreateDriver={
          modalMode === "add" ? handleCreateDriver : handlePatchDriver
        }
      />
      <DriverSummaryModal
